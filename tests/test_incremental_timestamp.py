...
def test_timestamp_column_coerced_to_datetime():
    ...
    assert result.tzinfo is None  # normalised to naive UTC
...
def test_non_iso_string_falls_back():
    stream = _stream()
...
def test_unresolved_type_falls_back_to_string():
...
def test_reflection_exception_is_swallowed():
